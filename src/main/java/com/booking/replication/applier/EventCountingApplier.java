...
public class EventCountingApplier implements Applier {
    ...
    @Override
    public void applyAugmentedRowsEvent(AugmentedRowsEvent augmentedSingleRowEvent, CurrentTransactionMetadata currentTransactionMetadata) throws ApplierException, IOException {
        wrapped.applyAugmentedRowsEvent(augmentedSingleRowEvent, currentTransactionMetadata);
        counter.inc();
    }
